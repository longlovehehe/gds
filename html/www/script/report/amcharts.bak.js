(function() {
    ...
    d.applyLang = function(a, b) {
        ...
        b.amString = "am";
        b.pmString = "pm";
        c && (c = c[a]) && (d.lang = c, c.monthNames && (b.dayNames = d.extend({},
    ...
    d.AxisBase = d.Class({
        ...
        pushAxisItem: function(a, b) {
            ...
            if (e = a.getLabel()) this.labelsSet.push(e),
            e.click(function(b) {
        ...
        parseDatesDraw: function() {
            ...
            var u, y = this.gridAlpha,
            x, w = this.choosePeriod(0),
            B = w.period,
            w = w.count,
            z = d.getPeriodDuration(B, w);
            z < k && (B = g.period, w = g.count, z = k);
            g = B;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var A = Math.ceil(this.timeDifference / z) + 5,
            C = l = d.resetDateToMin(new Date(this.startTime - z), B, w, t).getTime();
            if (g == B && 1 == w && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels) n = z * this.stepWidth,
            ...
            var D = 0,
            J = 0;
            a && 1 < w && (u = this.chooseMinorFrequency(w), x = d.getPeriodDuration(B, u), "DD" == B && (x += d.getPeriodDuration("hh")));
            if (0 < this.gridCountR) for (A - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= A; a++) {
                p = q + z * (a + Math.floor((C - q) / z)) - D;
                "DD" == B && (p += 36E5);
                p = d.resetDateToMin(new Date(p), B, w, t).getTime();
                "MM" == B && (h = (p - l) / z, 1.5 <= (p - l) / z && (p = p - (h - 1) * z + d.getPeriodDuration("DD", 3), p = d.resetDateToMin(new Date(p), B, 1).getTime(), D += z));
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u)) for (h = 1; h < w; h += u) this.gridAlpha = this.minorGridAlpha,
                f = p + x * h,
    ...
    d.ValueAxis = d.Class({
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                if (0 < B) {
                    ...
                    for (g = this.fillAlpha = 0; g < B; g++) {
                        ...
                        C = NaN,
                        D = A.above;
                        isNaN(A.toValue) || (C = this.getCoordinate(A.toValue), x = new this.axisItemRenderer(this, C, "", !0, NaN, NaN, A), this.pushAxisItem(x, D));
                        var J = NaN;
                        isNaN(A.value) || (J = this.getCoordinate(A.value), x = new this.axisItemRenderer(this, J, A.label, !0, NaN, (C - J) / 2, A), this.pushAxisItem(x, D));
                        isNaN(C) && (J -= 3, C = J + 3);
                        isNaN(C - J) || (x = new this.guideFillRenderer(this, J, C, A), this.pushAxisItem(x, D), x = x.graphics(), A.graphics = x, A.balloonText && this.addEventListeners(x, A))
                    }
                    this.fillAlpha = z
                }
                this.exponential = !1;
                for (g = f; g < t; g += p) w = d.roundTo(this.step * g + this.min, y),
                ...
                this.parseDatesDraw();
                else for (t >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), h && t++, g = f; g < t; g += p) if (c = y * g + this.minCalc, c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c) if (isNaN(r) || Number(d.toFixed(c, r)) == c) { ! 0 === h && (0 === c && (c = this.minReal), u > this.logGridLimit && (c = Math.pow(10, g)));
                    ...
                    if (c == this.baseValue && "radar" != a.type) {
                        ...
                        x = this.width;
                        B = this.height;
                        "H" == this.orientation ? 0 <= f && f <= x + 1 && (L = [f, f, f + k], P = [B, 0, l]) : 0 <= f && f <= B + 1 && (L = [0, x, x + k], P = [f, f, f + l]);
                        L && (f = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(this.zeroGridAlpha) || (f = this.zeroGridAlpha), f = d.line(a.container, L, P, this.gridColor, f, 1, this.dashLength), f.translate(this.x, this.y), this.grid0 = f, a.axesSet.push(f), f.toBack(), d.setCN(a, f, this.bcn + "zero-grid-" + this.id), d.setCN(a, f, this.bcn + "zero-grid"))
                    }
                    if (!isNaN(H) && 0 < w && g < t - 1) {
                        f = y / H;
                        h && (H = y * (g + p) + this.minCalc, H = d.roundTo(H, this.maxDecCount + 1), u > this.logGridLimit && (H = Math.pow(10, g + p)), f = 10, H = (H - c) / f);
                        x = this.gridAlpha;
                        this.gridAlpha = this.minorGridAlpha;
                        for (B = 1; B < f; B++) z = this.getCoordinate(c + H * B),
            ...
            for (d = a; d <= b; d++) {
                ...
                for (g in f) if (f.hasOwnProperty(g)) {
                    ...
                    if (k.includeInMinMax && (!k.hidden || this.includeHidden)) {
                        ...
                        l < c && (c = l),
                        l > e && (e = l);
                        else for (var m in k) k.hasOwnProperty(m) && "percents" != m && "total" != m && (l = k[m], l < c && (c = l), l > e && (e = l))
                    }
                }
            }
            return {
        ...
        zoomToValues: function(a, b, c) {
            ...
            c.chart = this.chart, c.valueAxis = this, c.startValue = a, c.endValue = b, c.relativeStart = this.relativeStart, c.relativeEnd = this.relativeEnd, this.fire(c)),
            !0
        },
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            "V" == Oa && (n = 0);
            var ba;
            P && "" !== c && (ba = a.autoWrap && 0 === n ? d.wrappedText(y, c, u, t, r, ga, k, Math.abs(h), 0) : d.text(y, c, u, t, r, ga, k), ga = ba.getBBox(), ha = ga.width, Pa = ga.height);
            if ("H" == Oa) {
                if (0 <= b && b <= ya + 1 && (0 < A && 0 < z && b + l <= ya + 1 && (fa = d.line(y, [b + l, b + l], [0, A], B, z, D), x.push(fa)), 0 < C && (za = d.line(y, [b, b + va, b + va], [X, X + la, la], J, C, D, H), x.push(za))), v = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ga = "start", v = "bottom" == ea ? I ? v + A: v - A: I ? v - A: v + A, G += 3, 0 < h && (G += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == ia && 0 < L && !g && !m && ca < ya && (e = d.fitToBounds(b, 0, ya), ca = d.fitToBounds(ca, 0, ya), Y = e - ca, 0 < Y && (Ca = d.rect(y, Y, a.height, R, L), Ca.translate(e - Y + va, la), x.push(Ca))), "bottom" == ea ? (v += X + r / 2 + da, I ? (0 < n ? (v = X - ha / 2 * Math.sin(T) - A - 3, G += ha / 2 * Math.cos(T) - 4 + 2) : 0 > n ? (v = X + ha * Math.sin(T) - A - 3 + 2, G += -ha * Math.cos(T) - Pa * Math.sin(T) - 4) : v -= A + r + 3 + 3, v -= Z) : (0 < n ? (v = X + ha / 2 * Math.sin(T) + A + 3, G -= ha / 2 * Math.cos(T)) : 0 > n ? (v = X + A + 3 - ha / 2 * Math.sin(T) + 2, G += ha / 2 * Math.cos(T)) : v += A + w + 3 + 3, v += Z)) : (v += la + r / 2 - da, G += va, I ? (0 < n ? (v = ha / 2 * Math.sin(T) + A + 3, G -= ha / 2 * Math.cos(T)) : v += A + 3, v += Z) : (0 < n ? (v = -(ha / 2) * Math.sin(T) - A - 6, G += ha / 2 * Math.cos(T)) : v -= A + r + 3 + w + 3, v -= Z)), "bottom" == ea ? Y = (I ? X - A - 1 : X + w - 1) + da: (ma = va, Y = (I ? la: la - A - w + 1) - da), f && (G += f), f = G, 0 < n && (f += ha / 2 * Math.cos(T)), ba && (r = 0, I && (r = ha / 2 * Math.cos(T)), f + r > ya + 2 || 0 > f)) ba.remove(),
                ba = null
            } else {
                0 <= b && b <= X + 1 && (0 < A && 0 < z && b + l <= X + 1 && (fa = d.line(y, [0, A + 1], [b + l, b + l], B, z, D), x.push(fa)), 0 < C && (za = d.line(y, [0, va, ya + va], [b, b + la, b + la], J, C, D, H), x.push(za)));
                ga = "end";
                if (!0 === I && "left" == ea || !1 === I && "right" == ea) ga = "start";
                v = b - Pa / 2 + 2;
                1 == ia && 0 < L && !g && !m && (e = d.fitToBounds(b, 0, X), ca = d.fitToBounds(ca, 0, X), T = e - ca, Ca = d.polygon(y, [0, a.width, a.width, 0], [0, 0, T, T], R, L), Ca.translate(va, e - T + la), x.push(Ca));
                v += r / 2;
                "right" == ea ? (G += va + ya + da, v += la, I ? (f || (v -= r / 2 + 3), G = G - (A + 4) - Z) : (G += A + 4 + w, v -= 2, G += Z)) : I ? (G += A + 4 - da, f || (v -= r / 2 + 3), g && (G += va, v += la), G += Z) : (G += -A - w - 4 - 2 - da, v -= 2, G -= Z);
                fa && ("right" == ea ? (ma += va + da + ya - 1, Y += la, ma = I ? ma - w: ma + w) : (ma -= da, I || (ma -= A + w)));
                f && (v += f);
                I = -3;
                "right" == ea && (I += la);
                ba && (v > X + 1 || v < I) && (ba.remove(), ba = null)
            }
            fa && (fa.translate(ma, Y), d.setCN(p, fa, a.bcn + "tick"), d.setCN(p, fa, q, !0), g && d.setCN(p, fa, "guide")); ! 1 === a.visible && (fa && fa.remove(), ba && (ba.remove(), ba = null));
            ba && (ba.attr({
                "text-anchor": ga
    ...
    d.AmChart = d.Class({
        ...
        measure: function() {
            ...
            if (a) {
                ...
                f = Math.round(d.toCoordinate(this.height, e)); (c != this.previousWidth || e != this.previousHeight) && 0 < a && 0 < f && (b.style.width = a + "px", b.style.height = f + "px", b.style.padding = 0, h && h.setSize(a, f), this.balloon = d.processObject(this.balloon, d.AmBalloon, this.theme), this.balloon.setBounds(2, 2, a - 2, f));
                this.balloon.chart = this;
                this.realWidth = a;
                this.realHeight = f;
                this.divRealWidth = c;
        ...
        handleDocTouchEnd: function() { - .5 < this.tmx && this.tmx < this.divRealWidth + 1 && 0 < this.tmy && this.tmy < this.divRealHeight ? (this.handleMouseMove(), 4 > Math.abs(this.mouseX - this.tmx) && 4 > Math.abs(this.mouseY - this.tmy) && (this.tapped = !0)) : this.tapped = !1
        },
        addListeners: function() {
            var a = this,
            b = a.chartDiv;
            document.addEventListener ? (a.panEventsEnabled && (b.style.msTouchAction = "none", b.style.touchAction = "none"), "ontouchstart" in document.documentElement && (b.addEventListener("touchstart",
            function(b) {
        ...
        brr: function() {
            if (!this.hideCredits) {
                ...
                if (c != a || !0 === this.inIframe()) {
                    ...
                    /*a=document.createElement("a");l=document.createTextNode(l);a.setAttribute("href",g);a.setAttribute("title",k);a.appendChild(l);this.chartDiv.appendChild(a);this.amLink=a;g=a.style;*/
                    g.position = "absolute";
    ...
    d.AmGraph = d.Class({
        ...
        positionLabel: function(a, b, c, e, d) {
            if (e) {
                ...
                case "left":
                    ...
                    break;
                case "inside":
                    "column" == this.type && (l = !0, q ? p ? (k = "end", b = r - 3 - y) : (k = "start", b = r + 3 + y) : c = p ? u + 7 + y: u - 10 - y);
                    break;
                case "middle":
                    "column" == this.type && (l = !0, q ? b -= (b - r) / 2 + y - 3 : c -= (c - u) / 2 + y - 3)
                }
                ...
                e && (0 > b || b > this.width || 0 > c || c > this.height) && (e.remove(), e = null);
                if (e && ("serial" == f.type || "gantt" == f.type)) if (q) {
                    if (0 > c || c > this.height) e.remove(),
                    e = null
                } else if (0 > b || b > this.width) e.remove(),
                e = null;
        ...
        createSerialGraph: function() {
            ...
            if (! (I || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Qa && void 0 == Ja || m))) {
                ...
                t ? (ha = q, Pa = Math.abs(Nb - Ka), ub = q, vb = Math.abs(ib - Ka), hb = tb = 0, f.reversed ? (ba = 0, gb = Ka) : (ba = Ka, gb = 0)) : (Pa = n, ha = Math.abs(Nb - Ka), vb = n, ub = Math.abs(ib - Ka), gb = ba = 0, f.reversed ? (hb = p, tb = Ka) : hb = Ka)
            }
            var La = Math.round;
            this.pmx = La(ba);
            this.pmy = La(tb);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < P) {
                    for (M = P - 1; - 1 < M; M--) if (G = e[M], v = G.axes[f.id].graphs[b], ma = v.values.value, !isNaN(ma)) {
                        P = M;
                        break
                    }
                    if (this.lineColorField) for (M = P; - 1 < M; M--) if (G = e[M], v = G.axes[f.id].graphs[b], v.lineColor) {
                        this.bulletColorSwitched = this.lineColorSwitched = v.lineColor;
                        break
                    }
                    if (this.fillColorsField) for (M = P; - 1 < M; M--) if (G = e[M], v = G.axes[f.id].graphs[b], v.fillColors) {
                        this.fillColorsSwitched = v.fillColors;
                        break
                    }
                    if (this.dashLengthField) for (M = P; - 1 < M; M--) if (G = e[M], v = G.axes[f.id].graphs[b], !isNaN(v.dashLength)) {
                        this.dashLengthSwitched = v.dashLength;
                        break
                    }
                }
                if (ia < e.length - 1) for (M = ia + 1; M < e.length; M++) if (G = e[M], v = G.axes[f.id].graphs[b], ma = v.values.value, !isNaN(ma)) {
                    ia = M;
                    break
                }
            }
            ...
            V = [],
            Ra = !1;
            if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == L || "100%" == L || this.fillToGraph) Ra = !0;
            ...
            for (M = P; M <= ia; M++) {
                ...
                v.index = M;
                var ab, Ta = NaN;
                if (m && void 0 == this.openField) for (var Ab = M + 1; Ab < e.length && (!e[Ab] || !(ab = e[M + 1].axes[f.id].graphs[b]) || !ab.values || (Ta = ab.values.value, isNaN(Ta))); Ab++);
                var S, Q, K, aa, na = NaN,
                E = NaN,
                F = NaN,
                O = NaN,
                ...
                if (Ia) {
                    ...
                    isNaN(ta) || (N = f.getCoordinate(ta, xb), m && "regular" != L && "100%" != L && (Ta = ta, ta = N = NaN));
                    ...
                    Ga = xa,
                    nb = 0;
                    "left" == this.stepDirection && (nb = (2 * Y + Wa * Y) / 2, na -= nb);
                    "center" == this.stepDirection && (nb = Y / 2, na -= nb);
                    "start" == this.pointPosition && (na -= Y / 2 + Math.floor(Wa * Y / 2), xa = 0, Ga = Math.floor(Y) + Math.floor(Wa * Y));
                    "end" == this.pointPosition && (na += Y / 2 + Math.floor(Wa * Y / 2), xa = Math.floor(Y) + Math.floor(Wa * Y), Ga = 0);
                    if (Pb) {
                        var Eb = this.columnWidth;
                        isNaN(Eb) || (xa *= Eb, Ga *= Eb)
                    }
                    I || (v.x = na); - 1E5 > na && (na = -1E5);
                    na > n + 1E5 && (na = n + 1E5);
                    t ? (E = F, O = N, N = F = na, isNaN(ta) && !this.fillToGraph && (O = la), pa = qa, ra = sa) : (O = E = na, isNaN(ta) && !this.fillToGraph && (N = la));
                    if (!Db && W < ta || Db && W < za) v.isNegative = !0,
                    Qa && (Ma = Qa),
                    Za && (Va = Za),
                    void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    ...
                    Qb || (void 0 != v.color && (Ma = v.color), v.fillColors && (Ma = v.fillColors));
                    switch (g) {
                    case "line":
                        if (isNaN(W)) y || (this.drawLineGraph(x, w, U, V), x = [], w = [], U = [], V = []);
                        else {
                            ...
                            Da = F;
                            ja = E;
                            ka = F; ! Ra || isNaN(N) || isNaN(O) || (U.push(O), V.push(N));
                            if ($a || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched || !isNaN(v.dashLength)) this.drawLineGraph(x, w, U, V),
                            x = [E],
                            w = [F],
                            U = [],
                            V = [],
                            !Ra || isNaN(N) || isNaN(O) || (U.push(O), V.push(N)),
                            m ? Sa ? (this.lineColorSwitched = ya, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Qa) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors),
                            this.dashLengthSwitched = v.dashLength;
                            v.gap && (this.drawLineGraph(x, w, U, V), x = [], w = [], U = [], V = [])
                        }
                        break;
                    case "smoothedLine":
                        if (isNaN(W)) y || (this.drawSmoothedGraph(x, w, U, V), x = [], w = [], U = [], V = []);
                        else {
                            if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) x.push(E),
                            w.push(F),
                            jb = E,
                            ...
                            ja = E;
                            ka = F; ! Ra || isNaN(N) || isNaN(O) || (U.push(O), V.push(N));
                            void 0 == v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(x, w, U, V), x = [E], w = [F], U = [], V = [], !Ra || isNaN(N) || isNaN(O) || (U.push(O), V.push(N)), this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched = v.dashLength);
                            v.gap && (this.drawSmoothedGraph(x, w, U, V), x = [], w = [], U = [], V = [])
                        }
                        break;
                    case "step":
                        if (!isNaN(W)) {
                            t ? (isNaN(B) || (x.push(B), w.push(F - xa)), w.push(F - xa), x.push(E), w.push(F + Ga), x.push(E), !Ra || isNaN(N) || isNaN(O) || (isNaN(A) || (U.push(A), V.push(N - xa)), U.push(O), V.push(N - xa), U.push(O), V.push(N + Ga))) : (isNaN(z) || (w.push(z), x.push(E - xa)), x.push(E - xa), w.push(F), x.push(E + Ga), w.push(F), !Ra || isNaN(N) || isNaN(O) || (isNaN(C) || (U.push(O - xa), V.push(C)), U.push(O - xa), V.push(N), U.push(O + Ga), V.push(N)));
                            B = E;
                            z = F;
                            A = O;
                            C = N;
                            ...
                            if ($a || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength)) {
                                ...
                                x = [ec];
                                w = [fc];
                                t ? (w.push(F + Ga), x.push(E)) : (x.push(E + Ga), w.push(F));
                                U = [];
                                V = [];
                            ...
                            if (1 >= this.periodSpan || 1 < this.periodSpan && E - B > xa + Ga) B = z = NaN;
                            this.drawLineGraph(x, w, U, V);
                            x = [];
                            w = [];
                            U = [];
                    ...
                    case "column":
                        ...
                        if (!isNaN(W)) {
                            ...
                            if (! (W < Rb && ob < Rb || W > Sb && ob > Sb)) {
                                var Ba;
                                if (t) {
                                    "3d" == L ? (Q = F - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + R * ea, S = O + H * ea, Ba = ea) : (Q = Math.floor(F - (r / 2 - ea) * (k + T) + T / 2), S = O, Ba = 0);
                                    K = k;
                                    wa = E;
                                    Da = Q + k / 2;
                                    ja = E;
                                    ...
                                    isNaN(G.percentWidthValue) || (K = this.height * G.percentWidthValue / 100, Q = zb, zb += K, Da = Q + K / 2);
                                    K = d.roundTo(K, 2);
                                    aa = d.roundTo(aa, 2);
                                    Q < q && 0 < K && (ua = new d.Cuboid(h, aa, K, H - a.d3x, R - a.d3y, Ma, Va, ca, Aa, X, ga, u, t, da, bb, mb, Z), v.columnWidth = Math.abs(aa), v.columnHeight = Math.abs(K))
                                } else {
                                    "3d" == L ? (S = E - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + H * ea, Q = N + R * ea, Ba = ea) : (S = E - (r / 2 - ea) * (k + T) + T / 2, Q = N, Ba = 0);
                                    K = k;
                                    wa = S + k / 2;
                                    Da = F;
                                    ja = S + k / 2;
                                    ...
                                    isNaN(G.percentWidthValue) || (K = this.width * G.percentWidthValue / 100, S = yb, yb += K, wa = S + K / 2);
                                    K = d.roundTo(K, 2);
                                    aa = d.roundTo(aa, 2);
                                    S < n + ea * H && 0 < K && (this.showOnAxis && (Q -= R / 2), ua = new d.Cuboid(h, K, aa, H - a.d3x, R - a.d3y, Ma, Va, ca, Aa, this.lineAlpha, ga, u, t, da, bb, mb, Z), v.columnHeight = Math.abs(aa), v.columnWidth = Math.abs(K))
                                }
                            }
                            if (ua) {
                                Ea = ua.set;
                                ...
                                S = d.roundTo(S, 2);
                                Q = d.roundTo(Q, 2);
                                Ea.translate(S, Q); (v.url || this.showHandOnHover) && Ea.setAttr("cursor", "pointer");
                                if (!I) {
                                    "none" == L && (J = t ? (this.end + 1 - M) * D - c: D * M + c);
                                    "3d" == L && (t ? (J = (this.end + 1 - M) * D - c - 1E3 * this.depthCount, wa += H * this.columnIndex, ja += H * this.columnIndex, v.y += H * this.columnIndex) : (J = (D - c) * (M + 1) + 1E3 * this.depthCount, Da += R * this.columnIndex, ka += R * this.columnIndex, v.y += R * this.columnIndex));
                                    if ("regular" == L || "100%" == L) J = t ? 0 < Ia.value ? (this.end + 1 - M) * D + c: (this.end + 1 - M) * D - c: 0 < Ia.value ? D * M + c: D * M - c;
                    ...
                    case "candlestick":
                        if (!isNaN(ta) && !isNaN(W)) {
                            ...
                            if (t) {
                                ...
                                if (0 === E && 0 === O && 0 === pa && 0 === ra) continue;
                                if (E == oa && O == oa && pa == oa && ra == oa) continue;
                                Q = F - k / 2;
                                S = O;
                                K = k;
                                Q + K > q && (K = q - Q);
                                ...
                                if (Q < q && 0 < K) {
                                    var Fb, Gb;
                                    W > ta ? (Fb = [E, ra], Gb = [O, pa]) : (Fb = [O, ra], Gb = [E, pa]); ! isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Fb, [F, F], Aa, X, ca), cb = d.line(h, Gb, [F, F], Aa, X, ca));
                                    aa = E - O;
                                ...
                                if (0 === F && 0 === N && 0 === qa && 0 === sa) continue;
                                if (F == Fa && N == Fa && qa == Fa && sa == Fa) continue;
                                S = E - k / 2;
                                Q = N + ca / 2;
                                K = k;
                                S + K > n && (K = n - S);
                                ...
                                if (S < n && 0 < K) {
                                    Db && W >= ta && (Va = 0);
                                    var ua = new d.Cuboid(h, K, aa, H, R, Ma, Va, ca, Aa, X, ga, u, t, da, bb, mb, Z),
                                    Hb,
                                    Ib;
                                    W > ta ? (Hb = [F, sa], Ib = [N, qa]) : (Hb = [N, sa], Ib = [F, qa]); ! isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Hb, Aa, X, ca), cb = d.line(h, [E, E], Ib, Aa, X, ca), d.setCN(a, Xa, this.bcn + "line-high"), v.className && d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"), v.className && d.setCN(a, cb, v.className, !0))
                                }
                            }
                            ua && (Ea = ua.set, v.columnGraphics = Ea, fa.push(Ea), Ea.translate(S, Q - ca / 2), (v.url || this.showHandOnHover) && Ea.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (v.x = t ? Q + K / 2 : S + K / 2, this.animateColumns(ua, M, E, O, F, N), this.addListeners(Ea, v)))
                        }
                        break;
                    case "ohlc":
                            ...
                            if ("regular" == L || "100%" == L) {
                                ...
                                if ($b) {
                                    ...
                                    if (Na) {
                                        ...
                                        t ? (eb = Da, db = 0 > W ? E - bc / 2 - 2 - fb - sb: E + bc / 2 + 3 + fb + sb) : (db = wa, eb = 0 > W ? F + cc / 2 + fb + sb: F - cc / 2 - 3 - fb - sb);
                                        Na.translate(db, eb);
                                        f.totals[M] = Na;
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(x, w, U, V) : this.drawLineGraph(x, w, U, V),
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                k.push(m.path);
                void 0 !== r && (n = new d.Bezier(g, a, b, r, w, n, t, 0, h), d.setCN(f, n, this.bcn + "stroke"), d.setCN(f, n, this.bcn + "stroke-negative"), l.push(n.path));
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + x + "," + b[b.length - 1], n += " L" + x + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + x, n += " L" + a[0] + "," + x), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== r) && (y || (y = q), u || (u = r), a = new d.Bezier(g, a, b, NaN, 0, 0, u, y, h, n), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        },
        ...
        handleRollOut: function(a, b) {
            ...
            this.handleGraphEvent(b, "rollOutGraph"); (c = this.chart.chartCursor) && c.valueBalloonsEnabled || this.hideBalloon()
        },
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        clipDragger: function(a) {
            ...
            if (b) {
                ...
                f = !1;
                if (this.rotate) {
                    if (c = 0, h = this.width + 1, this.clipY != d || this.clipH != b) f = !0
                } else if (d = 0, b = this.height + 1, this.clipX != c || this.clipW != h) f = !0;
                f && (this.clipAndUpdate(c, d, h, b), a && (this.updateOnReleaseOnly || this.dispatchScrollbarEvent()))
            }
        },
        maskGraphs: function() {},
        ...
        dispatchScrollbarEvent: function() {
            if (this.skipEvent) this.skipEvent = !1;
                ...
                g,
                k;
                this.rotate ? (b = d, g = this.height / f, k = 1 - d / this.height, c = 1 - (d + f) / this.height) : (b = c, g = this.width / h, k = c / this.width, c = (c + h) / this.width);
                this.fire({
                    type: "zoomed",
                    position: b,
                    chart: a,
        ...
        percentZoom: function(a, b) {
            if (this.dragger && this.enabled) {
                ...
                isNaN(b) && (b = 1);
                var c, d, h;
                this.rotate ? (c = this.height, d = c - c * b, h = c - c * a) : (c = this.width, h = c * b, d = c * a);
    ...
    d.ChartScrollbar = d.Class({
        ...
        dispatchScrollbarEvent: function() {
            if ("ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this);
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (a = g.lastTime, g = g.firstTime, k = Math.round(b / l) + g, b = this.dragging ? k + this.timeDifference: Math.round((b + c) / l) + g, k > b && (k = b), 0 < h && b - k < h && (b = Math.round(k + (b - k) / 2), e = Math.round(h / 2), k = b - e, b += e, e = !0), b > a && (b = a), b - h < k && (k = b - h), k < g && (k = g), k + h > b && (b = k + h), k != this.startTime || b != this.endTime) this.startTime = k,
                    this.endTime = b,
                    f.start = k,
                    f.end = b,
                    ...
                    this.fire(f)
                } else if (k.startOnAxis || (b += l / 2), c -= this.stepWidth / 2, h = k.xToIndex(b), b = k.xToIndex(b + c), h != this.start || this.end != b) k.startOnAxis && (this.resizingRight && h == b && b++, this.resizingLeft && h == b && (0 < h ? h--:b = 1)),
                this.start = h,
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    B = H + 2 * u;
                    D = J + 2 * r; ! isNaN(C) && D < C && (D = C);
                    window.opera && (B += 2);
                    var R = !1,
                    z = this.offsetY;
                    c.handDrawn && (z += c.handDrawScatter + 2);
                    "H" != x ? (C = a - D / 2, b < k + B + 10 && "down" != x ? (R = !0, e && (b += z), z = b + y, this.deltaSignY = -1) : (e && (b -= z), z = b - B - y, this.deltaSignY = 1)) : (2 * y > B && (y = B / 2), z = b - B / 2, a < g + (l - g) / 2 ? (C = a + y, this.deltaSignX = -1) : (C = a - D - y, this.deltaSignX = 1));
                    z + B >= m && (z = m - B);
                    z < k && (z = k);
                    C < g && (C = g);
                    C + D > l && (C = l - D);
                    ...
                    b, "easeOutSine"), n && (A.left = this.prevTX + "px", A.top = this.prevTY + "px", this.xAnim = c.animate({
                        node: n
                    },
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parsePartSerialData: function(a, b, c, e) {
            ...
            for (w = b; w < c; w++) {
                ...
                q && (A.labelColor = C[q]);
                x[C[g]] = A;
                if (k && (m.categoryFunction ? b = m.categoryFunction(b, C, m) : (!B || b instanceof Date || (b = b.toString() + " |"), b = d.getDate(b, B, m.minPeriod)), b = d.resetDateToMin(b, r, t, m.firstDayOfWeek), A.category = b, A.time = b.getTime(), isNaN(A.time))) continue;
                ...
                for (J = 0; J < D.length; J++) {
                    ...
                    for (R = 0; R < h.length; R++) {
                        ...
                        if (b.valueAxis.id == H) {
                            ...
                            var Z = C;
                            b.dataProvider && (Z = f);
                            I.values = this.processValues(Z, b, ia); ! b.connect && z && z[L] && 0 < P && A.time - u[L] >= y * P && (z[L].gap = !0);
    ...
    d.TrendLine = d.Class({
        ...
        draw: function() {
            ...
            B = b.dataDateFormat;
            k && (l && (l = d.getDate(l, B, "fff"), a.initialDate = l, e = k.dateToCoordinate(l)), m && (e = k.categoryToCoordinate(m)), n && (n = d.getDate(n, B, "fff"), a.finalDate = n, h = k.dateToCoordinate(n)), q && (h = k.categoryToCoordinate(q)));
            t && !w && (isNaN(r) || (e = t.getCoordinate(r)), isNaN(u) || (h = t.getCoordinate(u)));
            p && !w && (isNaN(y) || (f = p.getCoordinate(y)), isNaN(x) || (g = p.getCoordinate(x)));
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        e = a.set();
        var L;
        y && (x = r(10 * x), z = r(10 * z), C = r(10 * C), J = r(10 * J), B = r(10 * B), A = r(10 * A), D = r(10 * D), w = r(10 * w), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, u *= 10, 1 > Math.abs(h) && 1 >= Math.abs(C - z) && 1 >= Math.abs(D - A) && (L = !0));
        h = "";
        var P;
        q && (H["fill-opacity"] = 0, H["stroke-opacity"] = m["stroke-opacity"] / 2, H.stroke = m.stroke);
        if (0 < l) {
            P = " M" + x + "," + (B + l) + " L" + z + "," + (A + l);
            y ? (L || (P += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (A + l) + "," + C + "," + (D + l)), P += " L" + J + "," + (w + l), 0 < k && (L || (P += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," + (l + c + u) + "," + J + "," + (l + w) + "," + x + "," + (l + B)))) : (P += " A" + f + "," + g + ",0," + R + ",1," + C + "," + (D + l) + " L" + J + "," + (w + l), 0 < k && (P += " A" + k + "," + u + ",0," + R + ",0," + x + "," + (B + l)));
            P += " Z";
            var ia = l;
            y && (ia /= 10);
        ...
        y ? (L || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(z) + "," + r(A) + "," + r(C) + "," + r(D)), g = " M" + r(x) + "," + r(B) + " L" + r(z) + "," + r(A) + h + " L" + r(J) + "," + r(w)) : g = " M" + x + "," + B + " L" + z + "," + A + (" A" + f + "," + g + ",0," + R + ",1," + C + "," + D) + " L" + J + "," + w;
        0 < k && (y ? L || (g += " B" + (b - k) + "," + (c - u) + "," + (b + k) + "," + (c + u) + "," + J + "," + w + "," + x + "," + B) : g += " A" + k + "," + u + ",0," + R + ",0," + x + "," + B);
        a.handDrawn && (k = d.line(a, [x, z], [B, A], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(k));
        k = a.path(g + " Z", void 0, void 0, "1000,1000").attr(m);
        if (n) {
            u = [];
            for (y = 0; y < n.length; y++) u.push(d.adjustLuminosity(m.fill, n[y]));
            "radial" != t || d.isModern || (u = []);
            0 < u.length && k.gradient(t + "Gradient", u)
        }
        d.isModern && "radial" == t && k.grad && (k.grad.setAttribute("gradientUnits", "userSpaceOnUse"), k.grad.setAttribute("r", f), k.grad.setAttribute("gradientTransform", "translate(" + (b - a.width / 2) + "," + (c - a.height / 2) + ")"));
        k.pattern(q, NaN, p);
        e.wedge = k;
        e.push(k);
        return e
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (B = 0; B < x.length; B++) {
                ...
                w = J.getBBox();
                var H;
                this.equalWidths ? H = z * (p + n + this.markerLabelGap) : (H = A, A = A + w.width + f + n);
                w.height > D && (D = w.height);
                H + w.width > q && 0 < B && 0 !== z && (t++, H = z = 0, A = H + w.width + f + n, C = C + D + m, D = 0);
                J.translate(H, C);
                z++; ! isNaN(l) && z >= l && (z = 0, t++, C = C + D + m, A = f, D = 0);
                y.push(J)
            }
            w = y.getBBox();
            l = w.height + 2 * m - 1;
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                var f; ! 0 === a.hidden && (f = e = this.markerDisabledColor);
                var g = a.pattern,
                k = a.customMarker;
                ...
                if (this.useGraphSettings) {
                    ...
                    a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR),
                    n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength),
                    d.setCN(b, n, "graph-stroke"),
                    g.push(n),
                    a.bullet && (a.hidden || (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)),
                    p = 0,
                    n = m,
                    q = m / 3;
                    else {
                        ...
                        n = a.fillColorsR; ! 0 === a.hidden && (n = e);
                        if (g = this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, t, g, a.dashLength)) p = m,
                        g.translate(p, m / 2);
                        n = m
                    }
                    d.setCN(b, g, "graph-" + c);
                ...
                d.setCN(b, l, a.className, !0); (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (t = this.createX(), t.translate(m / 2, m / 2)) : t = this.createV(), t.dItem = a, !0 !== a.hidden ? "x" == f ? t.hide() : t.show() : "x" != f && t.hide(), this.switchable || t.hide(), this.addListeners(t, a), a.legendSwitch = t, l.push(t), d.setCN(b, t, "legend-switch"));
                f = this.color;
                a.showBalloon && this.textClickEnabled && void 0 !== this.selectedColor && (f = this.selectedColor);
                this.useMarkerColorForLabels && (f = e); ! 0 === a.hidden && (f = this.markerDisabledColor);
                e = d.massReplace(this.labelText, {
                    "[[title]]": a.title
                });
                t = this.fontSize;
                g && (m <= t && g.translate(p, m / 2 + this.ly - t / 2 + (t + 2 - m) / 2 - q), a.legendEntryWidth = g.getBBox().width);
                var u;
                e && (e = d.fixBrakes(e), a.legendTextReal = e, u = this.labelWidth, u = isNaN(u) ? d.text(this.container, e, f, b.fontFamily, t, "start") : d.wrappedText(this.container, e, f, b.fontFamily, t, "start", !1, u, 0), d.setCN(b, u, "legend-label"), u.translate(this.lx + n, this.ly), l.push(u), b = u.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
