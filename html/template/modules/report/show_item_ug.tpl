<form class="data">
	<div class="tablecharts">
		<div class="table-th" width="">{$list[0].ug_name}</div>
		<div class="table-th">{$onlyUg.sdr_online_count}</div>
		<div class="table-th">{$onlyUg.sdr_online_time}</div>
		<div class="table-th">{$onlyUg.sdr_audio_time}</div>
		<div class="table-th">{$onlyUg.sdr_video_time}</div>
		<div class="table-th">{$onlyUg.sdr_ptt_time}</div>
		<div class="table-th">{$onlyUg.sdr_send_sm_count}</div>
		<div class="table-th">{$onlyUg.sdr_send_pic_count}</div>
	</div>
    ...
    <table id="" class="base full" >
		...
		<tr class="none">
			<td>{$list[0].ug_name}</td>
			<td>{$onlyUg.sdr_online_count}</td>
			<td>{$onlyUg.sdr_online_time}</td>
			<td>{$onlyUg.sdr_audio_time}</td>
			<td>{$onlyUg.sdr_video_time}</td>
			<td>{$onlyUg.sdr_ptt_time}</td>
			<td>{$onlyUg.sdr_send_sm_count}</td>
			<td>{$onlyUg.sdr_send_pic_count}</td>
		</tr>
        ...
        <script>
            ...
            function makeCharts(theme, bgColor,data){
                ...
                get_call_time = AmCharts.makeChart("get_call_time", {
                    ...
                    dataProvider: [{
                        "country": "语音",
                        "litres": "{$onlyUg.sdr_audio_time}"
                    }, {
                        "country": "视频",
                        "litres": "{$onlyUg.sdr_video_time}"
                    }, {
                        "country": "对讲",
                        "litres": "{$onlyUg.sdr_ptt_time}"
                    }],
                    titleField: "country",
                    valueField: "litres",
                    labelText:"",
        ...
        <script>
            ...
            function makeCharts(theme, bgColor,data){
                ...
                get_call = AmCharts.makeChart("get_call", {
                    ...
                    dataProvider: [{
                        "country": "短信",
                        "litres": "{$onlyUg.sdr_send_sm_count}"
                    }, {
                        "country": "彩信",
                        "litres": "{$onlyUg.sdr_send_pic_count}"
                    }],
                    titleField: "country",
                    valueField: "litres",
                    labelText:"",
