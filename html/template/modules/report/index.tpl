{strip}
	...
	<form id="form" action="?m=report&a=report_item" method="post" data='{ "type" : "charts"}'>
		...
		<div class="condition-seacher" style="float:left;margin-right: 10px;">
            <div class="left">{"选择目标"|L}：</div>
            <div style="float:left;" class="select-portal none">
		...
		<div class="select_time">
			...
			<input autocomplete="off" style="height:24px;" class="datepickerreport start inputnothing" name="start" type="text" value="{$smarty.request.start}" readonly />
			<span>-</span>
			<span class="add-on"><i class="icon-calendar"></i></span>
			<input autocomplete="off" style="height:24px;" class="datepickerreport end inputnothing" name="end" type="text"  value="{$smarty.request.end}"  {*datatime="true"*} readonly />
	...
	<div class="ajaxcontent">
		...
		<div class="content charts2 none"></div>
		<div class="content charts3 none"></div>
		<div class="content charts4 none"></div>
		<div class="content charts5 none"></div>
		<div class="content charts6 none"></div>
		<div class="content charts7 none"></div>
		<div class="content charts8 none"></div>
		<div class="content charts9 none"></div>
		<div class="content charts10 none"></div>
		<div class="content charts11 none"></div>
		<div class="content charts12 none"></div>
		<div class="content charts13 none"></div>
		<div class="content charts14 none"></div>
		<div class="content charts15 none"></div>
		<div class="content charts16 none"></div>
		<div class="content charts17 none"></div>
		<div class="content charts18 none"></div>
		<div class="content charts19 none"></div>
	</div>
