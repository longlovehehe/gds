<form class="data">
    ...
    <div class="left">{"累计对讲时长"|L}：{$total}</div>
    <div class="right">
    ...
    <div class="get_day_info_speaking_time">
        ...
        <input type="hidden" name="json11" value='{$json}'>
        <script> 
        var chart1;
        var chart2;
...
$(function(){  
    ...
    {if !$list}
        $("#_speaking_time").children("div.amcharts-main-div").children("div.amcharts-chart-div").html('<div style="width:100%;line-height: 100%;text-align:center;font-size:14px;margin-top:140px;">【{"暂无数据"|L}】</div>');
    {/if}
}); 
</script>