{strip}
	...
	<style type="text/css">
		...
		.fg-button { clear:left; padding: 1px 0px 6px 0px; text-decoration:none !important; cursor:pointer; position: relative; text-align: center; zoom: 1; }
	...
	<form id="form" action="?m=report&a=review_item" method="post" data='{ "type" : "pies"}'>
		<input autocomplete="off"  name="modules" value="report" type="hidden" />
		<input autocomplete="off"  name="action" value="review_item" type="hidden" />
		...
		<div class="select_time">
			...
			<input autocomplete="off" style="height:24px;" class="datepickerreport start inputnothing" name="start" type="text" value="{$start}" readonly/>
		</div>
	...
	<div class="content pies"></div>
	<hr style="margin:10px 0px;">
	<div class="content pies1" style="float:left;width:360px;padding-right: 30px;"></div>
	<div class="content pies2" style="float:left;width:360px;"></div>
	<div class="content pies3" style="float:left;width:350px;padding-right: 30px;"></div>
	<div class="content pies4" style="float:left;width:350px;"></div>
	<div class="content pies5" style="float:left;"></div>
