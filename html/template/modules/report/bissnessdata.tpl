...
<form id="form" action="?m=report&a=bissnessdata_item" method="post" data='{ "type" : "charts"}'>
    ...
    <div class="condition-seacher" style="margin: 0px 10px 20px 0px;">
        <div class="left">
            <span>{"选择目标"|L}：</span>
        </div>
    ...
    <div class="select_time">
        ...
        <input autocomplete="off" style="height:24px;" class="datepickerreport start nothing" name="start" type="text" value="{$start}"  readonly/><span class="add-on"><i class="icon-calendar"></i></span>
        <span>-</span>
        <input autocomplete="off" style="height:24px;" class="datepickerreport end nothing" name="end" type="text" value="{$end}" {*datatime="true"*}readonly /><span class="add-on"><i class="icon-calendar"></i></span>
{*	<div id="main">
		<div class="demo">
			<div id="city_5">
    ...
    <hr style="margin:10px 0px;"/>
        {*<div class="toolbar mactoolbar open_data">
                 ...
                 <div class="left">
                    <input name="live_ratio" type="checkbox" ><span>存活比例</span>
                </div>
                 <div class="left">
                    <input name="users" type="checkbox" ><span>已创建用户数&新创建用户数</span>
                </div>
                 <div class="left">
                    <input name="users_type" type="checkbox" ><span>用户类型</span>
                </div>
                 <div class="left">
                    <input name="users_validity" type="checkbox" ><span>用户有效性</span>
                </div>
                 <div style="clear:both;"></div>
            </div>
            <div class="toolbar mactoolbar live_data none">
                 <div class="left">
                    <input name="live_num" type="checkbox" ><span>在线人数</span>
                </div>
                 <div class="left">
                    <input name="live_sum" type="checkbox" ><span>累计在线人数</span>
                </div>
                 <div class="left">
                    <input name="liveness" type="checkbox" ><span>活跃度</span>
                </div>
                 <div style="clear:both;"></div>
            </div>
        <div class="toolbar mactoolbar bissness_data none">
                 <div class="left">
                    <input name="intercom_recording" type="checkbox" ><span>对讲记录</span>
                </div>
                 <div class="left">
                    <input name="call_record" type="checkbox" ><span>单呼记录</span>
                </div>
                 <div class="left">
                    <input name="video_record" type="checkbox" ><span>视频通话记录</span>
                </div>
                 <div style="clear:both;"></div>
            </div>*}
...
<div class="content charts10 "></div>
<div class="content charts11 "></div>
<div class="content charts12 "></div>
<div class="content charts13 "></div>
<div class="content charts14 "></div>
<div class="content charts15 "></div>
{/strip}
