<?php /* Smarty version Smarty-3.1.11, created on 2016-06-08 14:51:25
         compiled from "..\template\modules\report\get_histogram.tpl" */ ?>
<?php /*%%SmartyHeaderCode:101615757c06ddafc62-47480372%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3677f0e11fea4cb058a78e61cb390dbf178a9dc3' => 
    array (
      0 => '..\\template\\modules\\report\\get_histogram.tpl',
      1 => 1464939703,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '101615757c06ddafc62-47480372',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5757c06e3f7926_48458582',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5757c06e3f7926_48458582')) {function content_5757c06e3f7926_48458582($_smarty_tpl) {?>    <div id="<?php echo $_smarty_tpl->tpl_vars['data_type']->value;?>
...
' />
 ...
 function makeCharts(data){
           chart = AmCharts.makeChart("<?php echo $_smarty_tpl->tpl_vars['data_type']->value;?>
", {
                type: "serial",
                dataProvider: data,
                categoryField: "date",
...
?>
            <tr>
                <td width="195px"><?php echo $_smarty_tpl->tpl_vars['item']->value['create_time'];?>
</td>
                <?php  $_smarty_tpl->tpl_vars['item1'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item1']->_loop = false;
 $_smarty_tpl->tpl_vars['key1'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['type_arr']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
",
        ...
        //终端类型的年 月 周 日 切换
        <?php if ($_smarty_tpl->tpl_vars['change_time']->value['check_date']!='day'){?>
        //_term_type_charts.addListener("clickGraphItem",term_type_charts_table);
        <?php }?>
...
&data_type=_term_type_data&table_type=term_type_data_table&index=666&stackType=none&total=total&time="+obj.item.dataContext.date
            });
        }
