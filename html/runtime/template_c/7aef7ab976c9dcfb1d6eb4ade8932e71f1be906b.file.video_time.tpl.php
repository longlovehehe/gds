<?php /* Smarty version Smarty-3.1.11, created on 2016-06-16 11:56:26
         compiled from "..\template\modules\report\bissnessdata\video_time.tpl" */ ?>
<?php /*%%SmartyHeaderCode:134655762236abb1285-79232620%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7aef7ab976c9dcfb1d6eb4ade8932e71f1be906b' => 
    array (
      0 => '..\\template\\modules\\report\\bissnessdata\\video_time.tpl',
      1 => 1464838518,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '134655762236abb1285-79232620',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5762236b0a1308_27732593',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5762236b0a1308_27732593')) {function content_5762236b0a1308_27732593($_smarty_tpl) {?><form class="data">
    <style>
            @font-face {
    ...
    <div class="left"><?php echo L("累计视频时长");?>
...
"><a href="javascript:void(0);"><?php echo L("日");?>
        ...
        <div class="_video_time right_nav table_video_time"></div>
        <div class="_video_time right_nav picture_video_time active"></div>
        
    </div>
</div>
    <div class="get_day_info_video_time">
        <div id="_video_time" style="height: 400px;width:750px;overflow-x: auto;"></div>
        <input type="hidden" name="json15" value='<?php echo $_smarty_tpl->tpl_vars['json']->value;?>
'>
        <script> 
        var chart1;
        var chart2;
        
        makeCharts("light", "#E5E5E5",eval($("input[name=json15]").val()));
        ...
        function makeCharts(theme, bgColor, data){
            ...
            // column chart
            chart1 = AmCharts.makeChart("_video_time", {
               type: "serial",
                dataProvider: data,
                categoryField: "date1",
                //startDuration: 1.5,
...
",
          ...
          chart1.addListener("clickGraphItem",video_time_table);
        <?php }?>
          <?php if ($_smarty_tpl->tpl_vars['res']->value['date_type']=='week'||$_smarty_tpl->tpl_vars['res']->value['date_type']=='month'){?>
          function video_time_table(obj){
...
<div class="video_time_table none">
   <script type="text/javascript"> 
    ...
    $(function(){
     var tab=$("#freezedivTable15"); 
     if(tab){
            fixupFirstRow(tab); 
        } 
    });
     if($("div.picture_video_time").attr("class").indexOf("active") > 0){
            $("#_video_time").removeClass("none");
            $("div.picture_video_time").addClass("charts_picture_hover");
            $("div.video_time_table").addClass("none");
            $("div.table_video_time").addClass("charts_table");
        }else{
            $("#_video_time").addClass("none");
            $("div.video_time_table").removeClass("none");
            $("div.table_video_time").addClass("charts_table_hover");
            $("div.picture_video_time").addClass("charts_picture");
        }
    $("div.table_video_time").bind("click",function(){
        $("div.table_video_time").addClass("charts_table_hover");
        $("div.picture_video_time").addClass("charts_picture");
        $("div.picture_video_time").removeClass("charts_picture_hover");
        $("div.video_time_table").removeClass("none");
        $("#_video_time").addClass("none");
    });
$("div.picture_video_time").bind("click",function(){
    $("div.picture_video_time").addClass("charts_picture_hover");
    $("div.table_video_time").addClass("charts_table");
    $("div.table_video_time").removeClass("charts_table_hover");
    $("div.video_time_table").addClass("none");
    $("#_video_time").removeClass("none");
});
$("div.day_video_time a").bind("click",function(){
    $("div.day_video_time a").css("color","#A83A39");
    $("div.week_video_time a").css("color","#121212");
    $("div.month_video_time a").css("color","#121212");
    $.ajax({
...
",
         ...
         success:function(res){
             $("div.get_day_info_video_time").html(res);
            }
        });
});
$("div.week_video_time a").bind("click",function(){
    $("div.week_video_time a").css("color","#A83A39");
    $("div.day_video_time a").css("color","#121212");
    $("div.month_video_time a").css("color","#121212");
    $.ajax({
...
$("div.month_video_time a").bind("click",function(){
    $("div.month_video_time a").css("color","#A83A39");
    $("div.day_video_time a").css("color","#121212");
    $("div.week_video_time a").css("color","#121212");
    $.ajax({
...
//$("div.day_video_time a").css("color","#A83A39");
$("div._video_time").bind("click",function(){
    $("div._video_time").each(function(){
...
<table  id="freezedivTable15" class="base full">
...
";
    ...
    <?php if (!$_smarty_tpl->tpl_vars['list']->value){?>
        $("#_video_time").children("div.amcharts-main-div").children("div.amcharts-chart-div").html('<div style="width:100%;line-height: 100%;text-align:center;font-size:14px;margin-top:140px;">【<?php echo L("暂无数据");?>
】</div>');
    <?php }?>
}); 
</script><?php }} ?>